...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p class="cent">ورود به سامانه</p>
<center>
<?php
$template->is_parametr("passwordset"," رمز عبور جدید برای شما تعیین شد و شما می توانید هم اکنون وارد سامانه شوید","green");
if(isset($_GET['empty']))
{
...
<p></p>
<form action="check.php" method="post" name="frmlogin">
...
<tr>
  <td><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="right">
      <input name="password" type="password" id="password" size="33" placeholder="password..." /></td>
    ...
    <tr>
      <td align="right"><input name="login2" type="reset" class="btn" id="login2" value="پاک کردن فرم" />        <input name="login" type="submit" class="btn" id="login" value="ورود به سیستم" /></td>
      <td align="right">&nbsp;</td>
    </tr>
  </table></td>
</tr>
...
<p class="ce"><a href="forgot.php">آیا رمز عبور خود را فراموش کرده اید؟</a></p>
</body>
</html>